  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-6 md:px-10 flex items-center justify-between h-18 py-3">
        ...
        <nav className="hidden md:flex items-center gap-5 lg:gap-7 text-[13.5px] lg:text-[15.5px] font-semibold uppercase tracking-[0.04em] text-text/90">
          {LINKS.map((l) => (
        ...
        <div className="hidden md:flex items-center gap-3">
          <button
            type="button"
            onClick={toggleTheme}
            className="inline-flex items-center gap-1.5 whitespace-nowrap rounded-full border border-line-strong px-3.5 py-2 font-mono text-[12px] uppercase tracking-[0.2em] text-text-dim transition-colors duration-200 hover:border-green hover:text-green"
          ...
          <button
            type="button"
            onClick={onRequestDemo}
            className="inline-flex lg:hidden items-center whitespace-nowrap rounded-full bg-gradient-to-r from-brand-lime via-brand-teal to-brand-blue px-4 py-2 text-[13px] font-semibold text-ink shadow-[0_0_18px_rgba(30,194,122,0.35)]"
          >
            Demo
          </button>
        </div>
